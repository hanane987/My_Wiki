...
<html>
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" type="text/css" href="yogaClass-1.0.0\css\bootstrap.min.css">
      <!-- style css -->
      ...
      <link rel="stylesheet" href="yogaClass-1.0.0\css\jquery.mCustomScrollbar.min.css">
               ...
               <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-md-4">
                              <h1 class="banner_taital">YOGA</h1>
                              <h2 class="banner_text">Day</h2>
