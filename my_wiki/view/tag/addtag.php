...
<body class="bg-gray-100">
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add tag</h2>
            <form action="index.php?action=addtag" method="post">

                <div class="grid gap-4 mb-4">
                    <div>
                        <label for="brand" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tag name</label>
                        <input type="text" name="tagName" id="name"
